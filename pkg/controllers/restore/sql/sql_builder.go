...
func DoResotreSQLReplacer(dest_tenant, source_tenant, dest_path, time, backup_cluster_name, backup_cluster_id, pool_list, restore_option string) *strings.Replacer {
