...
const (
	...
	DoResotreSql = "ALTER SYSTEM RESTORE ${dest_tenant} FROM ${source_tenant} at '${dest_path}' UNTIL '${time}' WITH 'backup_cluster_name=${backup_cluster_name}&backup_cluster_id=${backup_cluster_id}&pool_list=${pool_list}${restore_option}';"
)
