...
const (
	...
	GetRestoreSetSql         = "SELECT job_id, backup_cluster_id, backup_cluster_name, tenant_name, backup_tenant_name, status, backup_set_list, restore_start_timestamp FROM oceanbase.CDB_OB_RESTORE_HISTORY;"
	...
	DoResotreSql = "ALTER SYSTEM RESTORE '${dest_tenant}' FROM '${source_tenant}' at '${dest_path}' UNTIL '${time}' WITH 'backup_cluster_name='${backup_cluster_name}'&backup_cluster_id='${backup_cluster_id}'&pool_list='${pool_list}'';"
)
