...
type RestoreProgress struct {
	...
	TotalBytesDisplay  string `json:"total_bytes_display" db:"total_bytes_display"`
	FinishBytes        int64  `json:"finish_bytes" db:"finish_bytes"`
	FinishBytesDisplay string `json:"finish_bytes_display" db:"finish_bytes_display"`
...
type RestoreHistory struct {
	...
	FinishTimestamp      int64  `json:"finish_timestamp" db:"finish_timestamp"`
