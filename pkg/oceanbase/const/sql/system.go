...
const (
	tenantFields = "tenant_id, tenant_name, tenant_type, create_time, modify_time, primary_zone, locality, compatibility_mode, status, in_recyclebin, locked, tenant_role, sync_scn, replayable_scn, readable_scn, recovery_until_scn, log_mode, arbitration_service_status, switchover_status, switchover_epoch"
