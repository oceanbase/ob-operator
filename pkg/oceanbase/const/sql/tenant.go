...
const (
	...
	GetRsJob         = "select job_id, job_type, job_status, tenant_id, tenant_name from DBA_OB_TENANT_JOBS where tenant_name=? and job_status ='INPROGRESS' and job_type='ALTER_TENANT_LOCALITY'"
	...
	SetTenantVariable = "ALTER TENANT ${TENANT_NAME} ${VARIABLE_LIST}"
	SetUnitConfigV4   = "ALTER RESOURCE UNIT ${UNIT_NAME} ${ALTER_ITEM};"
	SetPoolUnitNum    = "ALTER RESOURCE POOL ${POOL_NAME} UNIT_NUM = ? "
