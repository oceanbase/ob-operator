...
var _ = Describe("Test Miscellaneous Operation", Label("misc"), func() {
	...
	It("Tenant name pattern", Label("pattern"), func() {
		pattern := regexp.MustCompile("^[a-zA-Z_][a-zA-Z0-9_]{0,127}$")
		Expect(pattern.MatchString("t1")).To(BeTrue())
		Expect(pattern.MatchString("_t1")).To(BeTrue())
		Expect(pattern.MatchString("_1")).To(BeTrue())
		Expect(pattern.MatchString("t_1")).To(BeTrue())
		Expect(pattern.MatchString("t")).To(BeTrue())
		Expect(pattern.MatchString("_")).To(BeTrue())
		Expect(pattern.MatchString("__")).To(BeTrue())
		Expect(pattern.MatchString("____")).To(BeTrue())
		Expect(pattern.MatchString(strings.Repeat("t", 127) + "1")).To(BeTrue())
		Expect(pattern.MatchString(strings.Repeat("_", 127) + "1")).To(BeTrue())
		Expect(pattern.MatchString(strings.Repeat("_", 128))).To(BeTrue())

		Expect(pattern.MatchString(strings.Repeat("_", 129))).NotTo(BeTrue())
		Expect(pattern.MatchString(strings.Repeat("t", 127) + "11")).NotTo(BeTrue())
		Expect(pattern.MatchString("11")).NotTo(BeTrue())
		Expect(pattern.MatchString("11")).NotTo(BeTrue())
	})
})
