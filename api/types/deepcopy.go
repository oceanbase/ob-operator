...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogServiceTemplate) DeepCopyInto(out *LogServiceTemplate) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogServiceTemplate.
func (in *LogServiceTemplate) DeepCopy() *LogServiceTemplate {
	if in == nil {
		return nil
	}
	out := new(LogServiceTemplate)
	in.DeepCopyInto(out)
	return out
}
