...
```shell
kubectl apply -f https://raw.githubusercontent.com/oceanbase/ob-operator/2.2.1_release/example/webapp/namespace.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/oceanbase/ob-operator/2.2.1_release/example/webapp/secret.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/oceanbase/ob-operator/2.2.1_release/example/webapp/configserver.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/oceanbase/ob-operator/2.2.1_release/example/webapp/obcluster.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/oceanbase/ob-operator/2.2.1_release/example/webapp/obproxy.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/oceanbase/ob-operator/2.2.1_release/example/webapp/tenant.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/oceanbase/ob-operator/2.2.1_release/example/webapp/ocp.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/oceanbase/ob-operator/2.2.1_release/example/webapp/prometheus.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/oceanbase/ob-operator/2.2.1_release/example/webapp/grafana.yaml
```
...
本文中的配置文件均可在 [webapp 配置文件](https://github.com/oceanbase/ob-operator/tree/2.2.1_release/example/webapp) 目录中找到。
