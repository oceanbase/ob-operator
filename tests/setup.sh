...
export OB_IMAGE=${OB_IMAGE:-oceanbase/oceanbase-cloud-native:4.2.1.7-107000162024060611}
...
export OB_IMAGE_430=${OB_IMAGE_430:-oceanbase/oceanbase-cloud-native:4.3.0.1-100000242024032211}
...
export OBAGENT_IMAGE_MONITOR=${OBAGENT_IMAGE_MONITOR:-oceanbase/obagent:4.2.2-100000042024011120}
