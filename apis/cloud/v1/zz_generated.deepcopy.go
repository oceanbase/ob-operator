...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TenantBackupJobStatus) DeepCopyInto(out *TenantBackupJobStatus) {
	*out = *in
	out.BackupJobs = in.BackupJobs
	if in.Interval != nil {
		in, out := &in.Interval, &out.Interval
		*out = make([]IntervalSpec, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TenantBackupJobStatus.
func (in *TenantBackupJobStatus) DeepCopy() *TenantBackupJobStatus {
	if in == nil {
		return nil
	}
	out := new(TenantBackupJobStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TenantBackupStatus) DeepCopyInto(out *TenantBackupStatus) {
	*out = *in
	if in.TenantBackupJob != nil {
		in, out := &in.TenantBackupJob, &out.TenantBackupJob
		*out = make([]TenantBackupJobStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
