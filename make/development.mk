...
run-local: manifests generate fmt vet ## Run a controller on your local host, with configurations in ~/.kube/config
	...
	CGO_ENABLED=0 GOCOVERDIR=testreports/covdata DISABLE_WEBHOOKS=true DISABLE_TELEMETRY=true go run -cover -covermode=atomic ./cmd/operator/main.go --log-verbosity=${LOG_LEVEL} 
