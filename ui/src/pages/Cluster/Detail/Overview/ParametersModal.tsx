    ...
    <Modal
      ...
      <Space>
          ...
          onClick={() => {
            onCancel();
            resetFields();
          }}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.42228E22", defaultMessage: "取消" })}
          ...
          onClick={() => {
            validateFields().then((values) => {
              ...
              updateParameters(namespace, name, objValue, intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.480E47F8", defaultMessage: "编辑参数已成功" }));
            });
          }}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.9F17E32D", defaultMessage: "确定" })}
