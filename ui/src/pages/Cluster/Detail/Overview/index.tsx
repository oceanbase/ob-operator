...
const ClusterOverview: React.FC = () => {
    ...
    <Button
      ...
      onClick={() => {
        if (removeNFS) {
          ...
          {removeNFS ? intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.C47B9DA4", defaultMessage: "移除 NFS 资源" }) : intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.6B97ABB6", defaultMessage: "挂载 NFS 资源" })}
        </Button>
  ...
  const header = () => {
    return {
      ...
      <Dropdown menu={{ items }} placement="bottomRight">
              <Button>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.A0A43F50", defaultMessage: "集群管理" })}
  ...
  {
    label: intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.403B7E1C", defaultMessage: "已托管" }),
    value: true
  },
  {
    label: intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.46B66B3E", defaultMessage: "未托管" }),
    value: false
  }];
  ...
  {
    label: <Tag color={'green'}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.D5CCD27D", defaultMessage: "已匹配" })}</Tag>,
    value: true
  },
  {
    label: <Tag color={'gold'}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.DF83C06D", defaultMessage: "不匹配" })}</Tag>,
    value: false
  }];
  ...
  const columns = [
  {
    title: intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.E5342F26", defaultMessage: "参数名" }),
    dataIndex: 'name'
  },
  {
    title: intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.FA0D096B", defaultMessage: "参数值" }),
    dataIndex: 'value'
  },
  {
    title: intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.93A9D19D", defaultMessage: "参数说明" }),
    dataIndex: 'info'
  },
  {
    title: intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.4FCF90AF", defaultMessage: "托管 operator" }),
    ...
    render: (text: boolean) => {
      return <span>{text ? intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.319FA0DB", defaultMessage: "是" }) : intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.5DD958C7", defaultMessage: "否" })}</span>;
    }
  },
  {
    title: <IconTip tip={intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.0B4A3E74", defaultMessage: "只有托管 operator 的参数才有状态" })} content={intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.6AD01A82", defaultMessage: "状态" })} />,
    dataIndex: 'accordance',
    width: 100,
    render: (text: boolean) => {
      const tagColor = text ? 'green' : 'gold';
      const tagContent = text ? intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.9A3A4407", defaultMessage: "已匹配" }) : intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.D6588C55", defaultMessage: "不匹配" });

      return <Tag color={tagColor}>{tagContent}</Tag>;
    }
  },
  {
    title: intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.1B9EA477", defaultMessage: "操作" }),
    dataIndex: 'controlParameter',
    render: (text, record) => {
      return (
        <Space size={1}>
            ...
            }}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.F5A088FB", defaultMessage: "编辑" })}


          </Button>
            {text &&
          <Button type="link" onClick={() => {}}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.5FACF7C0", defaultMessage: "解除托管" })}
  ...
  return (
    <PageContainer header={header()} loading={clusterDetailLoading}>
      <Row gutter={[16, 16]}>
        ...
        <Col span={24}>
          <Card
            title={<h2 style={{ marginBottom: 0 }}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.43C45255", defaultMessage: "节点资源配置" })}</h2>}
            extra={
            <Button
            ...
            <Descriptions title={intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.C5E0380E", defaultMessage: "计算资源" })}>
            ...
            <div
              style={{
                ...
                fontSize: '16px',
                marginBottom: '16px'
              }}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.05F3B008", defaultMessage: "存储资源" })}


            </div>
            <Space style={{ marginBottom: '16px' }}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.F4D80804", defaultMessage: "PVC 独立生命周期" })}

              <Tooltip title={intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.21732CE3", defaultMessage: "只能在创建时指定，不支持修改" })}>
                <Checkbox disabled />
              </Tooltip>
            </Space>
            <Descriptions>
        ...
        <Col span={24}>
          <Card title={<h2 style={{ marginBottom: 0 }}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.BFE7CA02", defaultMessage: "集群参数设置" })}</h2>}>
            <Form form={form}>
              <Row gutter={[24, 16]}>
                <Col span={6}>
                  <Form.Item label={intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.BF489BCE", defaultMessage: "参数名" })} name={'name'}>
                    <Input placeholder={intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.E5E4E6B5", defaultMessage: "请输入" })} allowClear />
                  </Form.Item>
                </Col>
                <Col span={6}>
                  <Form.Item label={intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.4F7F81B0", defaultMessage: "托管状态" })} name={'controlParameter'}>
                    <Select options={controlParameters} allowClear={true} />
                  </Form.Item>
                </Col>
                <Col span={6}>
                  <Form.Item label={intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.2873685C", defaultMessage: "状态" })} name={'accordance'}>
                ...
                <Col>
                  <Space size="middle">
                    <Button
                      ...
                      }}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.E3D520F9", defaultMessage: "查询" })}
                    ...
                    <Button
                      onClick={() => {
                        ...
                        refresh();
                      }}>{intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.96EEA6EE", defaultMessage: "重置" })}
      ...
      <NFSInfoModal
        removeNFS={removeNFS}
        title={removeNFS ? intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.24BBEBC2", defaultMessage: "移除 NFS 备份卷" }) : intl.formatMessage({ id: "src.pages.Cluster.Detail.Overview.44A8C98B", defaultMessage: "挂载 NFS 备份卷" })}
