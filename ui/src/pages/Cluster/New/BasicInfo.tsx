  ...
  return (
    <Card
      ...
      <Row gutter={[16, 32]}>
        ...
        <Col span={8}>
          <Form.Item
            label={intl.formatMessage({ id: "src.pages.Cluster.New.04047AB8", defaultMessage: "优化场景" })}
            name={'scenario'}
            initialValue="HTAP"
            rules={[
            {
              required: true,
              message: intl.formatMessage({ id: "src.pages.Cluster.New.8126F0B5", defaultMessage: "请选择优化场景" })
            }]
            }>
      ...
      <Space>{intl.formatMessage({ id: "src.pages.Cluster.New.FCB7C4F3", defaultMessage: "删除保护" })}
